 ...
 */
public class DifferentialDrive6193 extends RobotDriveBase {
	 public static final double kDefaultQuickStopThreshold = 0.2;
	   ...
	   */
	  public DifferentialDrive6193(SpeedController leftMotor, SpeedController rightMotor) {
	  ...
	  public String getDescription() {
	    return "DifferentialDrive6193";
	  }

	  @Override
	  public void initSendable(SendableBuilder builder) {
	    builder.setSmartDashboardType("DifferentialDrive6193");
